...
export const AudioToggle: React.FC<{ variant?: 'header' | 'floating' }> = ({ variant = 'header' }) => {
  ...
  const { toggleAudio } = useAudioEngine();
      ...
      className={`
        ...
        ${
          isFloating
            ...
            : 'bg-purple-50/70 hover:bg-purple-100/80 dark:bg-[#1A1230]/80 dark:hover:bg-[#251842] border border-purple-200/80 dark:border-purple-500/30 text-xs shadow-sm h-8 sm:h-9'
        }
      `}
    >
